...
values
  ...
  ('Pulled Pork Tacos', 'Tre myke tacos med langtidsstekt svinekjøtt, coleslaw, chipotle-aioli og syltet rødløk', 159, 'Hovedretter', 'https://images.unsplash.com/photo-1551504734-5ee1c4a1479b?w=400&h=300&fit=crop', null),
  ('Edamame', 'Dampede soyabønner med havsalt og sesamolje — en lett og sunn snack', 69, 'Småretter', 'https://images.unsplash.com/photo-1615485925600-97237c4fc1ec?w=400&h=300&fit=crop', null)
